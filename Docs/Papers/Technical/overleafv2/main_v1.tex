...
\documentclass[10pt,A4,draft]{article}
...
%Extracting Endogenous Information from Patent Semantic Data
%Patents Are Words: Extracting the Endogenous Information of Technological Innovation
%Classifying patents based on patent semantic content
%The Knowledge of Meaning Unveils the Meaning of Knowledge: Classifying Patents Based on their Semantic Content
Classifying Patents Based on their Semantic Content
% find a good title expressing both the multi-layer character and the novelty looking at semantic data
}
}
\newline
\\
...
\centering
%\hspace{-2.5cm}
%\includegraphics[width=0.45\textwidth,height=0.25\textheight]{figures/comnum_thetaw_2004.png}
%\includegraphics[width=0.45\textwidth,height=0.25\textheight]{figures/comnum_vcount_pareto_2004.png}
...
\begin{figure}
\centering
%\includegraphics[width=0.9\textwidth]{figures/meancomsize}
...
\centering
\hspace*{-2.5cm}
%\includegraphics[width=1.2\textwidth]{figures/all_raw_counts.png}
...
%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
%\includegraphics[width=0.49\textwidth]{figures/originality.png}
%\includegraphics[width=0.49\textwidth]{figures/generality.png}\\
...
\begin{figure}[!ht]
\centering
%\includegraphics[width=0.49\textwidth]{figures/norm-patents_all_density_semcounts.png}
%\includegraphics[width=0.49\textwidth]{figures/norm-patents_all_ts_semcounts.png} \\
%\includegraphics[width=0.49\textwidth]{figures/relative_all_density_semcounts.png}
%\includegraphics[width=0.49\textwidth]{figures/relative_all_ts_semcounts.png} 
...
%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[!ht]
%\includegraphics[width=0.49\textwidth]{figures/relative_interclassif_all_density_semcounts.png}
%\includegraphics[width=0.49\textwidth]{figures/relative_interclassif_all_ts_semcounts.png}
